...
class Statistics2Controller extends GetxController {
  ...
  Statistics2Controller({required this.token})
  ...
  final colorMap = {
    ...
    'offers_accepted_on_me': const Color(0xFF2196F3),
    'offers_rejected_on_me': const Color(0xFFF44336),
  ...
  Future<void> fetchStatistics() async {
    ...
    final response = await dataSource.getUserClientStatistics(token!);
