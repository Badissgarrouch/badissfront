...
class UsersInvit extends StatelessWidget {
  final CommercantControllerImp controller = Get.put(CommercantControllerImp());
  final GetFriendsControllerImp mycontroller = Get.put(
      GetFriendsControllerImp());
              ...
              Row(
                ...
                children: [
                  ElevatedButton.icon(
                    ...
                    icon: const Icon(
                        Icons.person_add_alt_1, size: 18, color: Colors.white),
                    label: Text(
                      "Friends".tr,
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Container(
          ...
          child: const Icon(
              Icons.chevron_right, color: AppColors.blue400, size: 20),
        ),
      ),
    );
  }
