...
import '../../widget/statistic2/courbes2.dart';
import '../../widget/statistic2/resume2.dart';
import '../../widget/statistic2/typecourbes2.dart';
import '../../widget/statistic2/typestatistic2.dart';
...
class Statistics2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(Statistics2Controller(token: token));
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  const Center(child: Typecourbes2()),
                  const SizedBox(height: 20),
                  const Resume2(),
                  const SizedBox(height: 20),
                ],
