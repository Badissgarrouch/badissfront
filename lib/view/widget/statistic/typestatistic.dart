...
class Typestatistic extends StatelessWidget {
  const Typestatistic({super.key});
  ...
  void _showMultiSelectDialog(BuildContext context, StatisticsController controller) {
    showDialog(
      context: context,
      builder: (context) {
